    ...
    <div className="h-full flex flex-col justify-between p-6 overflow-y-auto">
      <div>
        ...
        <div className="flex flex-col items-center mb-10 mt-4">
          ...
          <p className="text-gray-400 text-xs mt-1 uppercase tracking-widest font-medium opacity-80">Full Stack Developer <break> AI ML aspired </break></p>
        </div>
      ...
      <AnimatePresence>
        {(isOpen || (typeof window !== "undefined" && window.innerWidth >= 768)) && (
          ...
          >
            ...
            <SidebarContent activeSection={activeSection} handleMenuClick={handleMenuClick} />
          </motion.aside>
        )}
      </AnimatePresence>
    </>
