                ...
                {[
                  ...
                  >
                    <div className="flex items-center space-x-4">
                      {profile.icon === "github" && (
                        <svg className="text-gray-400 group-hover/link:text-white transition-colors" xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                      ...
                      {profile.icon === "linkedin" && (
                        <svg className="text-gray-400 group-hover/link:text-[#0A66C2] transition-colors" xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
