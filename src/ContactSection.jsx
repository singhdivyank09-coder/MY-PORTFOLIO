          ...
          >
            ...
            <div>
              ...
              <div className="flex space-x-4">
                ...
                <motion.a whileHover={{ y: -5, color: "#FFC107" }} href="https://www.instagram.com/divyank_09_/" target="_blank" rel="noreferrer" className="w-12 h-12 bg-gray-900 border border-gray-800 rounded-full flex items-center justify-center text-gray-400 transition-colors hover:border-[#FFC107]">
